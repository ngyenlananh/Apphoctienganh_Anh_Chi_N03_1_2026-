...
//       ),
//       home: const MyHomePage(title: 'my_mobile_appp'),
//     );
//   }
// }
...
//             const Text('You have pushed that button this many times:'),
//             Text(
//               '$_counter',
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      // Nhiệm vụ 4: Thay đổi Title của App
      title: 'App Học Tiếng Anh - Nhóm 03', 
      theme: ThemeData(
        colorScheme: ColorScheme.fromSeed(seedColor: Colors.blue),
        useMaterial3: true,
      ),
      // Nhiệm vụ 4: Truyền tiêu đề hiển thị trên thanh AppBar
      ...
      body: Center(
        child: Column(
          ...
          children: [
            ...
            // Nhiệm vụ 4: Hiển thị Họ tên và MSSV của các thành viên
            const Card(
              child: ListTile(
